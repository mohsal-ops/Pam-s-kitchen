...
export const metadata: Metadata = {
  ...
  description: `${SITE_CONFIG.name} caters all-day breakfast, burgers, homemade pizza, and daily specials for parties, corporate events, and gatherings in ${SITE_CONFIG.city}, ${SITE_CONFIG.state}. Request a custom quote today.`,
  keywords: [
  ...
  openGraph: {
    ...
    description: `Homemade comfort-food catering - breakfast, burgers, pizza, and daily specials for events in ${SITE_CONFIG.city}, ${SITE_CONFIG.state}.`,
    url: "/catering",
  },
};
